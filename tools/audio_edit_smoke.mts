...
const timeline:SequenceTimeline={
  ...
  entries:[
    {order:1,shot_id:'shot_1',continuity_break_before:false,accepted_ref:'a1',handoff_ref:'h1',attempt_id:'attempt_1',asset_uri:'https://example.test/shot1.mp4',spec_hash:'spec1',provider:'fal',model:'renderer-a',accepted_by_human_override:false,full_motion_review_confirmed:false,known_motion_defects_acknowledged:false,qa_decision:'PASS',motion_decision:'CLEAR_FOR_QA',motion_inspection_id:'m1',motion_sample_set_hash:'mh1',handoff_frame_sha256:'a'.repeat(64)},
    {order:2,shot_id:'shot_2',continuity_break_before:false,accepted_ref:'a2',handoff_ref:null,attempt_id:'attempt_2',asset_uri:'https://example.test/shot2.mp4',spec_hash:'spec2',provider:'fal',model:'renderer-a',accepted_by_human_override:false,full_motion_review_confirmed:false,known_motion_defects_acknowledged:false,qa_decision:'PASS',motion_decision:'CLEAR_FOR_QA',motion_inspection_id:'m2',motion_sample_set_hash:'mh2',handoff_frame_sha256:null}
  ],
