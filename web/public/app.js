...
function renderProductions(list){
  ...
  $$('.production-card',rail).forEach(card=>card.addEventListener('click',()=>enterStudio()));
}
...
['#newStoryBtn','#heroStart','#statementStart','#mobileNewStory'].forEach(id=>$(id)?.addEventListener('click',enterStudio));
